...
<head>
    ...
    <meta name="description" content="Suivez l'actualité de l'esport Français, accèder à nos événements passé et futur">
...
<body>
        ...
        <div class="row pt-4 text-white justify-content-center">
            ...
            -->
                <section class="col-md-12 col-lg-9 mt-5">
                    ...
                    <p>Dans un contexte français, et international, de professionnalisation et de structuration de la pratique des sports électroniques, les principaux acteurs de son développement en France se sont associés avec les syndicats professionnels
                        du jeu vidéo pour créer France Esports, association loi 1901 à but non lucratif. L’association France Esports a pour objet de développer, promouvoir, encadrer la pratique des sports électroniques dans un esprit d’équité et d’épanouissement
                        humain, s’inscrivant dans les valeurs et les principaux fondamentaux de l’Olympisme (Article 1 de ses statuts). L’association souhaite représenter les intérêts communs du monde amateur, du monde professionnel ainsi que des agents
                        économiques du secteur des sports électroniques.
                    </p>
                    <img class="mt-4 mb-4" alt="photo-evenements-pgw" title="Photo evenement pgw" src="./assets/fes-pgw-2016-768x432.jpg" width="100%" />
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vestibulum consequat quam, sit amet dapibus elit rutrum quis. Curabitur blandit urna dignissim bibendum cursus. Integer id augue lobortis, ultrices nisi eu, bibendum leo. Nulla velit justo,
                        elementum nec mattis sit amet, pharetra at libero. Ut non purus at nisi condimentum consequat. Pellentesque aliquam posuere justo, vel elementum felis auctor at. Proin cursus sollicitudin orci, non hendrerit massa bibendum eu.
                        In sollicitudin nec orci id eleifend. Sed ut commodo ex. Ut aliquet fringilla odio in sodales. Ut porta ante eu felis ornare bibendum. In quis sem nec ipsum mattis suscipit. Nunc lacinia tincidunt eros, et tristique tellus pharetra
                        in. Quisque ornare, libero nec viverra bibendum, ligula sapien blandit ipsum, cursus euismod augue risus id ante.
                        <br /><br /> In vitae convallis nisi, sit amet sodales justo. Suspendisse metus diam, aliquet sit amet accumsan vel, commodo ac ligula. Nullam magna ante, commodo at eros eget, maximus ultricies arcu. Ut accumsan ligula libero,
                        vehicula commodo nibh ultricies quis. Vestibulum ac orci eu felis sollicitudin varius nec tincidunt nisi. Aenean dolor nulla, luctus eu urna a, porttitor vestibulum elit. Ut eget turpis imperdiet, vulputate ipsum id, suscipit erat.
                        Vivamus vehicula volutpat felis tristique blandit. Sed interdum risus vitae commodo rhoncus. Suspendisse consequat eu tellus non laoreet. Aliquam auctor nec justo eget tempor. Fusce tempus dui ante, id efficitur eros condimentum
                        a. Fusce ipsum massa, pharetra vel nunc nec, pharetra euismod sem. Nulla tempor augue nec dictum pretium. Cras varius sodales est, et vehicula justo imperdiet et.
                    </p>
                </section>
                <!--
                ###
    ...
    <footer class="bg-dark text-center text-lg-start text-white mt-5">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2022 Copyright:
            <a class="text-light" href="#">france-esport.com</a>
        </div>
        <!-- Copyright -->
    </footer>
</body>
